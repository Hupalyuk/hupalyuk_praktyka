...
if (window.location.pathname.includes("about.html")) {
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const pressReleases = [
            {
                image: "assets/images/about-sec/about-sec-2-1.webp",
            ...
            {
                image: "assets/images/about-sec/about-sec-2-2.webp",
            ...
            {
                image: "assets/images/about-sec/about-sec-2-3.webp",
            ...
            {
                image: "assets/images/about-sec/about-sec-2-4.webp",
